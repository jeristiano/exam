<div class="row-fluid topLine">
	<div class="container-fluid">
		...
		<div class="span8">
			...
			{x2;if:$_user['teacher_subjects']}&nbsp;&nbsp;<em class="icon-edit"></em> <a href="index.php?exam-teach">教师管理</a>{x2;elseif:$_user['groupid'] == 1}&nbsp;&nbsp;<em class="icon-edit"></em> <a href="index.php?core-master">后台管理</a>{x2;endif}&nbsp;&nbsp;<a class="ajax" href="index.php?user-app-logout"><em class="icon-lock"></em> 退出</a>
			{x2;else}
