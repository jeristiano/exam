				...
				<ul class="thumbnails">
					...
					<li class="span2">
						<div class="thumbnail">
							...
							<div class="caption">
								<p class="text-center">
									<a class="ajax btn btn-success" href="index.php?exam-app-exampaper-selectquestions&examid={x2;v:exam['examid']}" title="{x2;v:exam['exam']}" action-before="clearStorage">{x2;substring:v:exam['exam'],28}</a>
								</p>
							</div>
						</div>
					</li>
