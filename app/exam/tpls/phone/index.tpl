				...
				<ul class="thumbnails">
					...
					<li class="span6">
						<div class="thumbnail">
							...
							<div class="caption">
								<p class="text-center">
									<a class="ajax btn btn-success" href="index.php?{x2;$_app}-phone-index-setCurrentBasic&basicid={x2;v:basic['basicid']}" title="{x2;v:basic['basic']}">{x2;substring:v:basic['basic'],15}</a>
								</p>
							</div>
						</div>
					</li>
