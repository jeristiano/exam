...
{x2;endif}
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					<a href="index.php?exam-master-basic-area&page={x2;$page}{x2;$u}">班级设置</a>
				</li>
			</ul>
	        <form action="index.php?exam-master-basic-addarea" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="args[areacode]" id="areacode" type="text" value="" needle="needle" msg="您必须输入班级邮编，且不能与原有班级重复" />
					</div>
				</div>
				<div class="control-group">
				  	<div class="controls">
