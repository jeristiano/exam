		...
		<div class="span10 exambox" id="datacontent">
			<div class="examform">
				<div >
					...
					<div>
						<div class="span3">
							<div class="thumbnail"><img alt="200x200" src="<?php if($this->tpl_var['_user']['photo']){ ?><?php echo $this->tpl_var['_user']['photo']; ?><?php } else { ?>app/user/styles/img/theme/stu.png<?php } ?>" /></div>
						</div>
						<div class="span3">
							<div class="caption">
