...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?exam-teach-rowsquestions-rowsdetail&questionid=<?php echo $this->tpl_var['questionparent']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">子试题列表</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?exam-teach-rowsquestions-rowsdetail&questionid=<?php echo $this->tpl_var['questionparent']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">子试题列表</a>
				</li>
			</ul>
