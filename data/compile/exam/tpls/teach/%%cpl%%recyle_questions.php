...
<?php } ?>
 ...
 $qid++; ?>
			        <tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn ajax" href="index.php?exam-teach-questions-backquestion&page=<?php echo $this->tpl_var['page']; ?>&questionid=<?php echo $question['questionid']; ?><?php echo $this->tpl_var['u']; ?>" title="恢复本题将会恢复本题下所有已删除子题"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?exam-teach-recyle-finaldelquestion&questionparent=0&page=<?php echo $this->tpl_var['page']; ?>&questionid=<?php echo $question['questionid']; ?><?php echo $this->tpl_var['u']; ?>" title="彻底删除"><em class="icon-remove"></em></a>
	                    	</div>
						</td>
			        </tr>
			        <?php } ?>
